...
CREATE TABLE `Invitation` (
    ...
    `privilege` ENUM('RO', 'RW', 'RWC') NOT NULL,
...
CREATE TABLE `Infrastructure` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `name` VARCHAR(191) NOT NULL,
    `locationAdresse` VARCHAR(191) NULL,
...
-- AddForeignKey
ALTER TABLE `Project` ADD CONSTRAINT `Project_infrastructureId_fkey` FOREIGN KEY (`infrastructureId`) REFERENCES `Infrastructure`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
